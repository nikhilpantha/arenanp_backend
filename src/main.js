...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, logger, corsOrigins, port;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    corsOrigins = (_a = config.get('app.corsOrigins')) !== null && _a !== void 0 ? _a : [];
                    app.enableCors({
                    ...
                    port = (_b = config.get('app.port')) !== null && _b !== void 0 ? _b : 4000;
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _c.sent();
                    logger.log("\uD83D\uDE80 ".concat(config.get('app.name'), " ready on ").concat(config.get('app.url')));
                    logger.log("\uD83D\uDCE1 GraphQL: ".concat(config.get('app.url'), "/graphql"));
                    logger.log("\u2764\uFE0F  Health:  ".concat(config.get('app.url'), "/health"));
                    return [2 /*return*/];
            }
        });
    });
