...
var PermissionGuard = function () {
    ...
    var PermissionGuard = _classThis = /** @class */ (function () {
        function PermissionGuard_1(reflector, permissions) {
            this.reflector = reflector;
            this.permissions = permissions;
        }
        PermissionGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var required, user, allowed;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            required = this.reflector.getAllAndOverride(require_permission_decorator_1.REQUIRE_PERMISSION_KEY, [
                                context.getHandler(),
                                context.getClass(),
                            ]);
                            ...
                            return [4 /*yield*/, this.permissions.userHasAllPermissions(user.id, required)];
                        case 1:
                            allowed = _a.sent();
                            if (!allowed) {
                                throw new common_1.ForbiddenException("Missing permission: ".concat(required.join(', ')));
                            }
                            return [2 /*return*/, true];
                    }
                });
        ...
        PermissionGuard_1.prototype.getUser = function (context) {
            var _a;
