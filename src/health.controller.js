...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(prisma, redis) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
            this.redis = redis;
        }
        HealthController_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                var started, _a, db, redis, overall;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            started = Date.now();
                            return [4 /*yield*/, Promise.all([this.pingDb(), this.pingRedis()])];
                        case 1:
                            _a = _b.sent(), db = _a[0], redis = _a[1];
                            overall = db.status === 'up' && redis.status === 'up' ? 'ok' : 'degraded';
                            return [2 /*return*/, {
                                    status: overall,
        ...
        HealthController_1.prototype.pingDb = function () {
            return __awaiter(this, void 0, void 0, function () {
                var e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            e_1 = _a.sent();
                            return [2 /*return*/, { status: 'down', error: e_1.message }];
                        case 3: return [2 /*return*/];
                    }
                });
            });
        };
        HealthController_1.prototype.pingRedis = function () {
            return __awaiter(this, void 0, void 0, function () {
                var res, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.redis.raw.ping()];
                        case 1:
                            res = _a.sent();
                            return [2 /*return*/, res === 'PONG' ? { status: 'up' } : { status: 'down', error: "unexpected: ".concat(res) }];
                        case 2:
                            e_2 = _a.sent();
                            return [2 /*return*/, { status: 'down', error: e_2.message }];
                        case 3: return [2 /*return*/];
                    }
                });
            });
    ...
    (function () {
        ...
        _check_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
