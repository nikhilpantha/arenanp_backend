...
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [auth_module_1.AuthModule, rbac_module_1.RbacModule, storage_module_1.StorageModule],
            providers: [users_service_1.UsersService, users_resolver_1.UsersResolver, users_repository_1.UsersRepository],
