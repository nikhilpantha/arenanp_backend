...
var UpdateProfileInput = function () {
    ...
    var UpdateProfileInput = _classThis = /** @class */ (function () {
        function UpdateProfileInput_1() {
            ...
            this.avatarUrl = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _avatarUrl_initializers, void 0));
            __runInitializers(this, _avatarUrl_extraInitializers);
        }
        return UpdateProfileInput_1;
    }());
    __setFunctionName(_classThis, "UpdateProfileInput");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _fullName_decorators = [(0, graphql_1.Field)({ nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 120)];
        _email_decorators = [(0, graphql_1.Field)({ nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEmail)()];
        _avatarUrl_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'S3 object key from createUploadUrl (category AVATAR).' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(512)];
        ...
        UpdateProfileInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpdateProfileInput = _classThis;
}();
