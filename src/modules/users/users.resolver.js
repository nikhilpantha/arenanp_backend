...
var user_model_1 = require("./dto/user.model");
var UsersResolver = function () {
    var _classDecorators = [(0, graphql_1.Resolver)(function () { return user_model_1.User; })];
    ...
    var UsersResolver = _classThis = /** @class */ (function () {
        function UsersResolver_1(usersService, storage, permissions) {
        ...
        UsersResolver_1.prototype.avatarUrl = function (user) {
        ...
        UsersResolver_1.prototype.me = function (current) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isStaff, staffPermissions, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.usersService.findById(current.id)];
                        case 1:
                            user = _b.sent();
                            isStaff = user.isStaff;
                            if (!isStaff) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.permissions.getUserPermissions(user.id)];
                        case 2:
                            _a = _b.sent();
                            return [3 /*break*/, 4];
                        case 3:
                        ...
                        case 4:
                            staffPermissions = _a;
                            return [2 /*return*/, (0, user_model_1.mapUserToGraphql)(__assign(__assign({}, user), { isStaff: isStaff, staffPermissions: staffPermissions }))];
                    }
                });
            });
        };
        UsersResolver_1.prototype.updateProfile = function (current, input) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.updateProfile(current.id, input)];
                        case 1:
                            user = _a.sent();
                            return [2 /*return*/, (0, user_model_1.mapUserToGraphql)(user)];
                    }
                });
            });
        };
        return UsersResolver_1;
    }());
    ...
    (function () {
        ...
        _me_decorators = [AllowWhilePasswordPending(), (0, graphql_1.Query)(function () { return user_model_1.User; }, { description: 'Returns the currently authenticated user.' })];
        _updateProfile_decorators = [(0, graphql_1.Mutation)(function () { return user_model_1.User; }, { description: 'Update the current user profile (name / email / avatar).' })];
