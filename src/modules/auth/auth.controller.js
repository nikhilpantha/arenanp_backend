...
var AuthController = function () {
    var _classDecorators = [(0, common_1.Controller)('auth'), (0, throttle_auth_decorator_1.ThrottleAuth)()];
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.requestOtp = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.requestOtp(body.phoneNumber)];
                });
            });
        };
        AuthController_1.prototype.verifyOtp = function (body, response) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, user, token;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.authService.verifyOtp(body.phoneNumber, body.code)];
                        case 1:
                            _a = _b.sent(), user = _a.user, token = _a.token;
                            response.setHeader('Set-Cookie', "accessToken=".concat(token.accessToken, "; HttpOnly; Secure; SameSite=Strict; Path=/; Max-Age=900"));
                            return [2 /*return*/, {
        ...
        AuthController_1.prototype.loginWithEmail = function (body, response) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, user, token;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.authService.loginWithEmail(body.email, body.password)];
                        case 1:
                            _a = _b.sent(), user = _a.user, token = _a.token;
                            response.setHeader('Set-Cookie', "accessToken=".concat(token.accessToken, "; HttpOnly; Secure; SameSite=Strict; Path=/; Max-Age=900"));
                            return [2 /*return*/, {
    ...
    (function () {
        ...
        _requestOtp_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('otp/request'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _verifyOtp_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('otp/verify'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _loginWithEmail_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
