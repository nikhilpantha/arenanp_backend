...
exports.RefreshSessionInput = void 0;
var graphql_1 = require("@nestjs/graphql");
var class_validator_1 = require("class-validator");
var RefreshSessionInput = function () {
    ...
    var RefreshSessionInput = _classThis = /** @class */ (function () {
        function RefreshSessionInput_1() {
            /**
        ...
        return RefreshSessionInput_1;
    }());
    __setFunctionName(_classThis, "RefreshSessionInput");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _refreshToken_decorators = [(0, graphql_1.Field)({
                nullable: true,
                description: 'Refresh token, for clients that store it themselves (the phone app). Omit on web: ' +
        ...
        RefreshSessionInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RefreshSessionInput = _classThis;
}();
exports.RefreshSessionInput = RefreshSessionInput;
