...
exports.PaginatedVenueVerificationRequests = void 0;
var graphql_1 = require("@nestjs/graphql");
var pagination_input_1 = require("../../../../common/dto/pagination.input");
var venue_verification_request_model_1 = require("./venue-verification-request.model");
var PaginatedVenueVerificationRequests = function () {
    ...
    var PaginatedVenueVerificationRequests = _classThis = /** @class */ (function () {
        function PaginatedVenueVerificationRequests_1() {
        ...
        return PaginatedVenueVerificationRequests_1;
    }());
    __setFunctionName(_classThis, "PaginatedVenueVerificationRequests");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _items_decorators = [(0, graphql_1.Field)(function () { return [venue_verification_request_model_1.VenueVerificationRequestModel]; })];
        ...
        PaginatedVenueVerificationRequests = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaginatedVenueVerificationRequests = _classThis;
}();
exports.PaginatedVenueVerificationRequests = PaginatedVenueVerificationRequests;
