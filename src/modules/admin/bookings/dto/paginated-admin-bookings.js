...
exports.PaginatedAdminBookings = void 0;
var graphql_1 = require("@nestjs/graphql");
var pagination_input_1 = require("../../../../common/dto/pagination.input");
var admin_booking_model_1 = require("./admin-booking.model");
var PaginatedAdminBookings = function () {
    ...
    var PaginatedAdminBookings = _classThis = /** @class */ (function () {
        function PaginatedAdminBookings_1() {
        ...
        return PaginatedAdminBookings_1;
    }());
    __setFunctionName(_classThis, "PaginatedAdminBookings");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _items_decorators = [(0, graphql_1.Field)(function () { return [admin_booking_model_1.AdminBooking]; })];
        ...
        PaginatedAdminBookings = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaginatedAdminBookings = _classThis;
}();
exports.PaginatedAdminBookings = PaginatedAdminBookings;
