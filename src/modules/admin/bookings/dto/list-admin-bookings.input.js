...
exports.ListAdminBookingsInput = void 0;
...
var ListAdminBookingsInput = function () {
    ...
    var ListAdminBookingsInput = _classThis = /** @class */ (function () {
        function ListAdminBookingsInput_1() {
            ...
            this.venueId = (__runInitializers(this, _search_extraInitializers), __runInitializers(this, _venueId_initializers, void 0));
            this.sport = (__runInitializers(this, _venueId_extraInitializers), __runInitializers(this, _sport_initializers, void 0));
            this.status = (__runInitializers(this, _sport_extraInitializers), __runInitializers(this, _status_initializers, void 0));
            this.paymentProvider = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _paymentProvider_initializers, void 0));
            this.fromDate = (__runInitializers(this, _paymentProvider_extraInitializers), __runInitializers(this, _fromDate_initializers, void 0));
        ...
        return ListAdminBookingsInput_1;
    }());
    __setFunctionName(_classThis, "ListAdminBookingsInput");
    (function () {
        ...
        _venueId_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Venue id to scope by.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
        _sport_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Sport filter (matches the court sport).' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(40)];
        _status_decorators = [(0, graphql_1.Field)(function () { return client_1.BookingStatus; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.BookingStatus)];
        _paymentProvider_decorators = [(0, graphql_1.Field)(function () { return client_1.PaymentProvider; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.PaymentProvider)];
        _fromDate_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Inclusive start of the booking startAt range (ISO).' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Date; }), (0, class_validator_1.IsDate)()];
        _toDate_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Exclusive end of the booking startAt range (ISO).' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Date; }), (0, class_validator_1.IsDate)()];
        ...
        ListAdminBookingsInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ListAdminBookingsInput = _classThis;
}();
exports.ListAdminBookingsInput = ListAdminBookingsInput;
