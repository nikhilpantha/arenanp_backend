...
exports.SportStub = void 0;
exports.mapSportStub = mapSportStub;
var graphql_1 = require("@nestjs/graphql");
var SportStub = function () {
    ...
    var SportStub = _classThis = /** @class */ (function () {
        function SportStub_1() {
    ...
    __setFunctionName(_classThis, "SportStub");
    (function () {
        ...
        SportStub = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SportStub = _classThis;
}();
exports.SportStub = SportStub;
function mapSportStub(s) {
    var _a;
    return {
        id: s.id,
        slug: s.slug,
        name: s.name,
        iconUrl: (_a = s.iconUrl) !== null && _a !== void 0 ? _a : undefined,
    };
}
