...
exports.ListAdminDisputesInput = void 0;
...
var ListAdminDisputesInput = function () {
    ...
    var ListAdminDisputesInput = _classThis = /** @class */ (function () {
        function ListAdminDisputesInput_1() {
            ...
            this.search = (__runInitializers(this, _category_extraInitializers), __runInitializers(this, _search_initializers, void 0));
        ...
        return ListAdminDisputesInput_1;
    }());
    __setFunctionName(_classThis, "ListAdminDisputesInput");
    (function () {
        ...
        _status_decorators = [(0, graphql_1.Field)(function () { return client_1.DisputeStatus; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.DisputeStatus)];
        _category_decorators = [(0, graphql_1.Field)(function () { return client_1.DisputeCategory; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.DisputeCategory)];
        _search_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Match on subject, customer name, phone or venue.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(120)];
        ...
        ListAdminDisputesInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ListAdminDisputesInput = _classThis;
}();
exports.ListAdminDisputesInput = ListAdminDisputesInput;
