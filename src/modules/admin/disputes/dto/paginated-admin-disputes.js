...
exports.PaginatedAdminDisputes = void 0;
var graphql_1 = require("@nestjs/graphql");
var pagination_input_1 = require("../../../../common/dto/pagination.input");
var admin_dispute_model_1 = require("./admin-dispute.model");
var PaginatedAdminDisputes = function () {
    ...
    var PaginatedAdminDisputes = _classThis = /** @class */ (function () {
        function PaginatedAdminDisputes_1() {
        ...
        return PaginatedAdminDisputes_1;
    }());
    __setFunctionName(_classThis, "PaginatedAdminDisputes");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _items_decorators = [(0, graphql_1.Field)(function () { return [admin_dispute_model_1.AdminDispute]; })];
        ...
        PaginatedAdminDisputes = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaginatedAdminDisputes = _classThis;
}();
exports.PaginatedAdminDisputes = PaginatedAdminDisputes;
