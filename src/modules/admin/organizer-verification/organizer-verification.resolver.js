...
exports.OrganizerVerificationResolver = void 0;
...
var list_organizer_verification_requests_input_1 = require("./dto/list-organizer-verification-requests.input");
var paginated_organizer_verification_requests_1 = require("./dto/paginated-organizer-verification-requests");
var organizer_verification_request_model_1 = require("./dto/organizer-verification-request.model");
var OrganizerVerificationResolver = function () {
    var _classDecorators = [(0, graphql_1.Resolver)(function () { return organizer_verification_request_model_1.OrganizerVerificationRequestModel; }), (0, require_permission_decorator_1.RequirePermission)('organizers.view')];
    ...
    var OrganizerVerificationResolver = _classThis = /** @class */ (function () {
        function OrganizerVerificationResolver_1(service, storage) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.storage = storage;
        }
        /** Presign the stored KYC document keys into temporary download URLs for the admin. */
        OrganizerVerificationResolver_1.prototype.documentUrls = function (req) {
            return this.storage.getDownloadUrls(req.documentUrls);
        };
        OrganizerVerificationResolver_1.prototype.list = function (input) {
            return this.service.list(input !== null && input !== void 0 ? input : new list_organizer_verification_requests_input_1.ListOrganizerVerificationRequestsInput());
        };
        OrganizerVerificationResolver_1.prototype.getOne = function (id) {
            return this.service.getOne(id);
        };
        OrganizerVerificationResolver_1.prototype.approve = function (input, actor) {
            return this.service.approve(input, actor);
        };
        OrganizerVerificationResolver_1.prototype.reject = function (input, actor) {
            return this.service.reject(input, actor);
        };
        OrganizerVerificationResolver_1.prototype.suspend = function (userId, actor) {
            return this.service.suspendAccess(userId, actor);
        };
        OrganizerVerificationResolver_1.prototype.reinstate = function (userId) {
            return this.service.reinstateAccess(userId);
        };
        return OrganizerVerificationResolver_1;
    }());
    __setFunctionName(_classThis, "OrganizerVerificationResolver");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _documentUrls_decorators = [(0, graphql_1.ResolveField)(function () { return [String]; })];
        _list_decorators = [(0, graphql_1.Query)(function () { return paginated_organizer_verification_requests_1.PaginatedOrganizerVerificationRequests; }, {
        ...
        _getOne_decorators = [(0, graphql_1.Query)(function () { return organizer_verification_request_model_1.OrganizerVerificationRequestModel; }, {
                name: 'adminOrganizerVerificationRequest',
                description: 'Single organizer-verification submission with submitted info + reviewer.',
            })];
        _approve_decorators = [(0, require_permission_decorator_1.RequirePermission)('organizers.verify'), (0, graphql_1.Mutation)(function () { return organizer_verification_request_model_1.OrganizerVerificationRequestModel; }, {
                name: 'adminApproveOrganizerVerification',
                description: 'Approve a pending organizer-verification request.',
            })];
        _reject_decorators = [(0, require_permission_decorator_1.RequirePermission)('organizers.reject'), (0, graphql_1.Mutation)(function () { return organizer_verification_request_model_1.OrganizerVerificationRequestModel; }, {
                name: 'adminRejectOrganizerVerification',
                description: 'Reject a pending organizer-verification request with a reason.',
            })];
        _suspend_decorators = [(0, require_permission_decorator_1.RequirePermission)('organizers.suspend'), (0, graphql_1.Mutation)(function () { return admin_user_model_1.AdminUser; }, {
                name: 'adminSuspendOrganizerAccess',
                description: 'Suspend organizer access on a user (organizerStatus -> SUSPENDED).',
            })];
        _reinstate_decorators = [(0, require_permission_decorator_1.RequirePermission)('organizers.activate'), (0, graphql_1.Mutation)(function () { return admin_user_model_1.AdminUser; }, {
        ...
        OrganizerVerificationResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrganizerVerificationResolver = _classThis;
}();
exports.OrganizerVerificationResolver = OrganizerVerificationResolver;
