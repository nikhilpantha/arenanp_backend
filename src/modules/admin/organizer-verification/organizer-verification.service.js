...
exports.OrganizerVerificationService = void 0;
...
var OrganizerVerificationService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var OrganizerVerificationService = _classThis = /** @class */ (function () {
        function OrganizerVerificationService_1(repo) {
            this.repo = repo;
        }
        OrganizerVerificationService_1.prototype.list = function (input) {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    items: items.map(organizer_verification_request_model_1.mapOrganizerRequestToGraphql),
        ...
        OrganizerVerificationService_1.prototype.getOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var row;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            row = _a.sent();
                            if (!row)
                                throw new common_1.NotFoundException('Organizer verification request not found.');
                            return [2 /*return*/, (0, organizer_verification_request_model_1.mapOrganizerRequestToGraphql)(row)];
                    }
                });
            });
        };
        OrganizerVerificationService_1.prototype.approve = function (input, actor) {
            return __awaiter(this, void 0, void 0, function () {
                var row, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            updated = _a.sent();
                            return [2 /*return*/, (0, organizer_verification_request_model_1.mapOrganizerRequestToGraphql)(updated)];
                    }
                });
            });
        };
        OrganizerVerificationService_1.prototype.reject = function (input, actor) {
            return __awaiter(this, void 0, void 0, function () {
                var row, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         */
        OrganizerVerificationService_1.prototype.suspendAccess = function (userId, actor) {
            return __awaiter(this, void 0, void 0, function () {
                var updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (userId === actor.id) {
                                throw new common_1.BadRequestException('You cannot suspend your own organizer access.');
                            }
        ...
        OrganizerVerificationService_1.prototype.reinstateAccess = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return OrganizerVerificationService_1;
    }());
    __setFunctionName(_classThis, "OrganizerVerificationService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        OrganizerVerificationService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrganizerVerificationService = _classThis;
}();
exports.OrganizerVerificationService = OrganizerVerificationService;
