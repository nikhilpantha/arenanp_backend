...
exports.ApproveOrganizerVerificationInput = exports.RejectOrganizerVerificationInput = void 0;
var graphql_1 = require("@nestjs/graphql");
var class_validator_1 = require("class-validator");
var RejectOrganizerVerificationInput = function () {
    ...
    var RejectOrganizerVerificationInput = _classThis = /** @class */ (function () {
        function RejectOrganizerVerificationInput_1() {
        ...
        return RejectOrganizerVerificationInput_1;
    }());
    __setFunctionName(_classThis, "RejectOrganizerVerificationInput");
    (function () {
        ...
        RejectOrganizerVerificationInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RejectOrganizerVerificationInput = _classThis;
}();
exports.RejectOrganizerVerificationInput = RejectOrganizerVerificationInput;
var ApproveOrganizerVerificationInput = function () {
    var _classDecorators = [(0, graphql_1.InputType)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    ...
    var ApproveOrganizerVerificationInput = _classThis = /** @class */ (function () {
        function ApproveOrganizerVerificationInput_1() {
            this.requestId = __runInitializers(this, _requestId_initializers, void 0);
        ...
        return ApproveOrganizerVerificationInput_1;
    }());
    __setFunctionName(_classThis, "ApproveOrganizerVerificationInput");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _requestId_decorators = [(0, graphql_1.Field)(function () { return graphql_1.ID; }), (0, class_validator_1.IsString)()];
        ...
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ApproveOrganizerVerificationInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ApproveOrganizerVerificationInput = _classThis;
}();
exports.ApproveOrganizerVerificationInput = ApproveOrganizerVerificationInput;
