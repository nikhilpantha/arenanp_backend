...
exports.PaginatedAdminPayments = void 0;
var graphql_1 = require("@nestjs/graphql");
var pagination_input_1 = require("../../../../common/dto/pagination.input");
var admin_payment_model_1 = require("./admin-payment.model");
var PaginatedAdminPayments = function () {
    ...
    var PaginatedAdminPayments = _classThis = /** @class */ (function () {
        function PaginatedAdminPayments_1() {
        ...
        return PaginatedAdminPayments_1;
    }());
    __setFunctionName(_classThis, "PaginatedAdminPayments");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _items_decorators = [(0, graphql_1.Field)(function () { return [admin_payment_model_1.AdminPayment]; })];
        ...
        PaginatedAdminPayments = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaginatedAdminPayments = _classThis;
}();
exports.PaginatedAdminPayments = PaginatedAdminPayments;
