...
exports.ListAdminPaymentsInput = void 0;
...
var ListAdminPaymentsInput = function () {
    ...
    var ListAdminPaymentsInput = _classThis = /** @class */ (function () {
        function ListAdminPaymentsInput_1() {
            ...
            this.provider = (__runInitializers(this, _search_extraInitializers), __runInitializers(this, _provider_initializers, void 0));
            this.status = (__runInitializers(this, _provider_extraInitializers), __runInitializers(this, _status_initializers, void 0));
            this.settlementStatus = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _settlementStatus_initializers, void 0));
            this.venueId = (__runInitializers(this, _settlementStatus_extraInitializers), __runInitializers(this, _venueId_initializers, void 0));
            this.fromDate = (__runInitializers(this, _venueId_extraInitializers), __runInitializers(this, _fromDate_initializers, void 0));
        ...
        return ListAdminPaymentsInput_1;
    }());
    __setFunctionName(_classThis, "ListAdminPaymentsInput");
    (function () {
        ...
        _provider_decorators = [(0, graphql_1.Field)(function () { return client_1.PaymentProvider; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.PaymentProvider)];
        _status_decorators = [(0, graphql_1.Field)(function () { return client_1.PaymentStatus; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.PaymentStatus)];
        _settlementStatus_decorators = [(0, graphql_1.Field)(function () { return client_1.SettlementStatus; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.SettlementStatus)];
        _venueId_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Scope to one venue.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
        _fromDate_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Inclusive lower bound for paidAt (ISO).' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Date; }), (0, class_validator_1.IsDate)()];
        _toDate_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Exclusive upper bound for paidAt (ISO).' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Date; }), (0, class_validator_1.IsDate)()];
        ...
        ListAdminPaymentsInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ListAdminPaymentsInput = _classThis;
}();
exports.ListAdminPaymentsInput = ListAdminPaymentsInput;
