...
exports.ListAdminVenuesInput = void 0;
...
var ListAdminVenuesInput = function () {
    ...
    var ListAdminVenuesInput = _classThis = /** @class */ (function () {
        function ListAdminVenuesInput_1() {
            ...
            this.verificationStatus = (__runInitializers(this, _search_extraInitializers), __runInitializers(this, _verificationStatus_initializers, void 0));
            this.city = (__runInitializers(this, _verificationStatus_extraInitializers), __runInitializers(this, _city_initializers, void 0));
            this.sport = (__runInitializers(this, _city_extraInitializers), __runInitializers(this, _sport_initializers, void 0));
            this.isFeatured = (__runInitializers(this, _sport_extraInitializers), __runInitializers(this, _isFeatured_initializers, void 0));
            this.sortOrder = (__runInitializers(this, _isFeatured_extraInitializers), __runInitializers(this, _sortOrder_initializers, admin_user_model_1.SortOrder.DESC));
            __runInitializers(this, _sortOrder_extraInitializers);
        }
        return ListAdminVenuesInput_1;
    }());
    __setFunctionName(_classThis, "ListAdminVenuesInput");
    (function () {
        ...
        _search_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Match on venue name, owner name, owner phone or city.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(120)];
        _verificationStatus_decorators = [(0, graphql_1.Field)(function () { return client_1.VenueVerificationStatus; }, { nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.VenueVerificationStatus)];
        ...
        _sport_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'Filter venues that offer this sport.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(40)];
        _isFeatured_decorators = [(0, graphql_1.Field)({ nullable: true, description: 'true = only featured, false = only non-featured.' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)()];
        ...
        ListAdminVenuesInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ListAdminVenuesInput = _classThis;
}();
exports.ListAdminVenuesInput = ListAdminVenuesInput;
