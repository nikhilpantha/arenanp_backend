...
exports.AdminVenuesRepository = void 0;
...
var AdminVenuesRepository = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var AdminVenuesRepository = _classThis = /** @class */ (function () {
        function AdminVenuesRepository_1(prisma) {
            this.prisma = prisma;
        }
        AdminVenuesRepository_1.prototype.findById = function (id) {
            return this.prisma.venue.findUnique({ where: { id: id }, include: VENUE_INCLUDES });
        };
        AdminVenuesRepository_1.prototype.listAndCount = function (input) {
                    ...
                    switch (_g.label) {
                        case 0:
                            ...
                            if (typeof input.isFeatured === 'boolean')
                                where.isFeatured = input.isFeatured;
        ...
        AdminVenuesRepository_1.prototype.updateVerification = function (args) {
            var _a;
            return this.prisma.venue.update({
                where: { id: args.venueId },
                data: {
                    verificationStatus: args.nextStatus,
                    rejectionReason: (_a = args.rejectionReason) !== null && _a !== void 0 ? _a : null,
        ...
        AdminVenuesRepository_1.prototype.setFeatured = function (venueId, isFeatured) {
            return this.prisma.venue.update({
                where: { id: venueId },
                data: {
        ...
        return AdminVenuesRepository_1;
    }());
    __setFunctionName(_classThis, "AdminVenuesRepository");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AdminVenuesRepository = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AdminVenuesRepository = _classThis;
}();
exports.AdminVenuesRepository = AdminVenuesRepository;
