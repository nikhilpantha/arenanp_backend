...
export class SubscriptionsResolver {
  ...
  @Query(() => MembershipStatsModel, {
    ...
    description:
      "Venue membership KPIs. `monthlyRevenue` is omitted unless the caller holds 'venue.finance.view'.",
  })
  @UseGuards(VenuePermissionGuard)
  @RequireVenuePermission('venue.bookings.view')
  venueMembershipStats(
    ...
    return this.service.stats(venueId, canRead(access, 'venue.finance.view'));
  }
}
