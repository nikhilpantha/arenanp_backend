...
@InputType()
export class InviteVenueOwnerInput {
...
@InputType()
export class AcceptVenueOwnerInvitationInput {
...
@InputType()
export class RevokeVenueOwnerInvitationInput {
  @Field(() => ID)
  @IsString()
  invitationId!: string;
}
...
@InputType()
export class ResendVenueOwnerInvitationInput {
  @Field(() => ID)
  @IsString()
  invitationId!: string;
}
