...
var offers_repository_1 = require("./offers.repository");
var offers_resolver_1 = require("./offers.resolver");
...
var OffersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [offers_resolver_1.OffersResolver, offers_service_1.OffersService, offers_repository_1.OffersRepository, venue_permission_guard_1.VenuePermissionGuard],
            exports: [offers_service_1.OffersService],
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var OffersModule = _classThis = /** @class */ (function () {
        function OffersModule_1() {
        }
        return OffersModule_1;
    }());
    __setFunctionName(_classThis, "OffersModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        OffersModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OffersModule = _classThis;
}();
