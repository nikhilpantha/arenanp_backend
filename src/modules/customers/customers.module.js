...
var customers_repository_1 = require("./customers.repository");
var customers_resolver_1 = require("./customers.resolver");
...
var CustomersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [customers_resolver_1.CustomersResolver, customers_service_1.CustomersService, customers_repository_1.CustomersRepository, venue_permission_guard_1.VenuePermissionGuard],
            exports: [customers_repository_1.CustomersRepository],
        })];
