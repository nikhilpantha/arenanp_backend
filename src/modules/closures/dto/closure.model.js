...
exports.ClosureModel = void 0;
exports.mapClosure = mapClosure;
var graphql_1 = require("@nestjs/graphql");
var ClosureModel = function () {
    var _classDecorators = [(0, graphql_1.ObjectType)({ description: 'A venue-owner block on bookings — one court or the whole venue.' })];
    ...
    var ClosureModel = _classThis = /** @class */ (function () {
        function ClosureModel_1() {
        ...
        return ClosureModel_1;
    }());
    __setFunctionName(_classThis, "ClosureModel");
    (function () {
        ...
        _courtId_decorators = [(0, graphql_1.Field)(function () { return graphql_1.ID; }, { nullable: true, description: 'Blocked court; null = whole venue.' })];
        _startAt_decorators = [(0, graphql_1.Field)()];
        _endAt_decorators = [(0, graphql_1.Field)()];
        _reason_decorators = [(0, graphql_1.Field)({ nullable: true })];
        ...
        ClosureModel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ClosureModel = _classThis;
}();
exports.ClosureModel = ClosureModel;
function mapClosure(c) {
    var _a, _b;
    return {
        id: c.id,
        venueId: c.venueId,
        courtId: (_a = c.courtId) !== null && _a !== void 0 ? _a : undefined,
        startAt: c.startAt,
        endAt: c.endAt,
        reason: (_b = c.reason) !== null && _b !== void 0 ? _b : undefined,
