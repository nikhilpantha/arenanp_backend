...
var storage_resolver_1 = require("./storage.resolver");
/**
...
var StorageModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [storage_service_1.StorageService, storage_resolver_1.StorageResolver],
            exports: [storage_service_1.StorageService],
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var StorageModule = _classThis = /** @class */ (function () {
        function StorageModule_1() {
        }
        return StorageModule_1;
    }());
